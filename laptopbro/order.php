...
<?php 
 ...
 <?php
	...
	if(isset($_GET['delid'])){
    	...
    	$time = $_GET['time'];
    	$price = $_GET['price'];
    	$del_shifted = $ct->del_shifted($id,$time,$price);// xóa đơn hàng
    }
?>
<style type="text/css">
.tblone th {
			    	...
			    	<h3>Đơn hàng</h3>
						...
						<table class="tblone">
							...
							<tr>
                                ...
                                <td><a href="?delid=<?php echo $result['id'] ?>&price=<?php echo $result['price']; ?>&time=<?php echo $result['date_order'] ?>">Hủy đơn</a></td>
								<?php 
								}elseif($result['status'] == '1') {
								 ?>
