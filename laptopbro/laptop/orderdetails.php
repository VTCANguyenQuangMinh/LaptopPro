...
<div class="main">
    <div class="content">
        ...
        <h3>Chi tiết đơn hàng: <?php echo $id ?> -
	        ...
	        if ($result['status'] == '0') {
			?>
            <span class='erorr' style="font-size: 15px;">Đang chờ xử lý</span>

            <?php 
			}elseif($result['status'] == 1) {
			?>
			<span class='erorr' style="font-size: 15px;">Đã hủy</span>

            <?php 
			}elseif($result['status'] == 2) {
			?>
			<span class='erorr' style="font-size: 15px;">Đang giao hàng</span>

            <?php 
			}elseif($result['status'] == 3) {
			?>
			<span class='erorr' style="font-size: 15px;">Giao thành công</span>
